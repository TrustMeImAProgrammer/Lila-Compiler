...
_lr_productions = [
  ...
  ('file_input_end -> file_input ENDMARKER','file_input_end',2,'p_file_input_end','garden.py',363),
  ('file_input -> file_input NEWLINE','file_input',2,'p_file_input','garden.py',366),
  ('file_input -> file_input stmt','file_input',2,'p_file_input','garden.py',367),
  ('file_input -> NEWLINE','file_input',1,'p_file_input','garden.py',368),
  ('file_input -> stmt','file_input',1,'p_file_input','garden.py',369),
  ('funcdef -> DEF NAME parameters COLON suite','funcdef',5,'p_funcdef','garden.py',385),
  ('parameters -> LPAR RPAR','parameters',2,'p_parameters','garden.py',390),
  ('parameters -> LPAR varargslist RPAR','parameters',3,'p_parameters','garden.py',391),
  ('varargslist -> varargslist COMMA NAME','varargslist',3,'p_varargslist','garden.py',401),
  ('varargslist -> NAME','varargslist',1,'p_varargslist','garden.py',402),
  ('stmt -> simple_stmt','stmt',1,'p_stmt_simple','garden.py',410),
  ('stmt -> compound_stmt','stmt',1,'p_stmt_compound','garden.py',415),
  ('simple_stmt -> small_stmts NEWLINE','simple_stmt',2,'p_simple_stmt','garden.py',420),
  ('simple_stmt -> small_stmts SEMICOLON NEWLINE','simple_stmt',3,'p_simple_stmt','garden.py',421),
  ('small_stmts -> small_stmts SEMICOLON small_stmt','small_stmts',3,'p_small_stmts','garden.py',425),
  ('small_stmts -> small_stmt','small_stmts',1,'p_small_stmts','garden.py',426),
  ('small_stmt -> flow_stmt','small_stmt',1,'p_small_stmt','garden.py',435),
  ('small_stmt -> expr_stmt','small_stmt',1,'p_small_stmt','garden.py',436),
  ('expr_stmt -> testlist ASSIGN testlist','expr_stmt',3,'p_expr_stmt','garden.py',444),
  ('expr_stmt -> testlist','expr_stmt',1,'p_expr_stmt','garden.py',445),
  ('flow_stmt -> return_stmt','flow_stmt',1,'p_flow_stmt','garden.py',453),
  ('return_stmt -> RETURN testlist','return_stmt',2,'p_return_stmt','garden.py',458),
  ('compound_stmt -> if_stmt','compound_stmt',1,'p_compound_stmt','garden.py',463),
  ('compound_stmt -> funcdef','compound_stmt',1,'p_compound_stmt','garden.py',464),
  ('if_stmt -> IF test COLON suite','if_stmt',4,'p_if_stmt','garden.py',468),
  ('suite -> simple_stmt','suite',1,'p_suite','garden.py',472),
  ('suite -> NEWLINE INDENT stmts DEDENT','suite',4,'p_suite','garden.py',473),
  ('stmts -> stmts stmt','stmts',2,'p_stmts','garden.py',481),
  ('stmts -> stmt','stmts',1,'p_stmts','garden.py',482),
  ('comparison -> comparison PLUS comparison','comparison',3,'p_comparison','garden.py',524),
  ('comparison -> comparison MINUS comparison','comparison',3,'p_comparison','garden.py',525),
  ('comparison -> comparison MULT comparison','comparison',3,'p_comparison','garden.py',526),
  ('comparison -> comparison DIV comparison','comparison',3,'p_comparison','garden.py',527),
  ('comparison -> comparison LT comparison','comparison',3,'p_comparison','garden.py',528),
  ('comparison -> comparison EQ comparison','comparison',3,'p_comparison','garden.py',529),
  ('comparison -> comparison GT comparison','comparison',3,'p_comparison','garden.py',530),
  ('comparison -> PLUS comparison','comparison',2,'p_comparison','garden.py',531),
  ('comparison -> MINUS comparison','comparison',2,'p_comparison','garden.py',532),
  ('comparison -> power','comparison',1,'p_comparison','garden.py',533),
  ('power -> atom','power',1,'p_power','garden.py',545),
  ('power -> atom trailer','power',2,'p_power','garden.py',546),
  ('atom -> NAME','atom',1,'p_atom_name','garden.py',556),
  ('atom -> NUMBER','atom',1,'p_atom_number','garden.py',560),
  ('atom -> STRING','atom',1,'p_atom_number','garden.py',561),
  ('atom -> LPAR testlist RPAR','atom',3,'p_atom_tuple','garden.py',565),
  ('trailer -> LPAR arglist RPAR','trailer',3,'p_trailer','garden.py',570),
  ('testlist -> testlist_multi COMMA','testlist',2,'p_testlist','garden.py',576),
  ('testlist -> testlist_multi','testlist',1,'p_testlist','garden.py',577),
  ('testlist_multi -> testlist_multi COMMA test','testlist_multi',3,'p_testlist_multi','garden.py',591),
  ('testlist_multi -> test','testlist_multi',1,'p_testlist_multi','garden.py',592),
  ('test -> comparison','test',1,'p_test','garden.py',607),
  ('arglist -> arglist COMMA argument','arglist',3,'p_arglist','garden.py',615),
  ('arglist -> argument','arglist',1,'p_arglist','garden.py',616),
  ('argument -> test','argument',1,'p_argument','garden.py',624),
]
